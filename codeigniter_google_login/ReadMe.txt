...
3. Open the "application/config/google.php" file and specify Client ID (client_id), Client Secret (client_secret), and Redirect URL (redirect_uri) according to your Facebook App credentials.
...
============ May I Help You ===========
If you have any query about this script, please feel free to comment here - http://www.codexworld.com/login-with-google-account-in-codeigniter/#respond. We will reply your query ASAP.